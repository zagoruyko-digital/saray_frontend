...
const base = css`
    ...
    ${
        ...
        props.primary               ?   'color: ' + Theme.white + ';' + 'background-color: ' + Theme.primary + ';' :
        props.secondary             ?   'color: ' + Theme.white + ';' + 'background-color: ' + Theme.secondary + ';' :
        props.primary-outline       ?   'color: ' + Theme.primary + ';' + 'background-color: ' + Theme.white + '; border: 1px solid ' + Theme.primary + ';' :
        props.secondary-outline     ?   'color: ' + Theme.secondary + ';' + 'background-color: ' + Theme.white + '; border: 1px solid ' + Theme.secondary + ';' :
        'color: ' + Theme.primary + ';' + 'background-color: transparent;'
    }
